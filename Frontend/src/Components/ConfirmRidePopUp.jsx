        ...
        <div className='h-screen'>
            ...
            <div className='flex items-center justify-between mt-7'>
                <div className='flex items-center '>
                    ...
                    <h2 className='text-lg font-medium capatialize'>{props.ride?.user.fullname.firstname + props.ride?.user.fullname.lastname}</h2>
                </div>
            ...
            <div >
                <form className='flex flex-col items-center justify-evenly px-6 py-4 gap-5 pb-2 mt-4' onSubmit={(e) => {
                    ...
                    <button className='bg-green-500 rounded-xl text-lg font-semibold p-2 w-full flex justify-center items-center'>Confirm button</button>
