           ...
           <div className='w-full'>
                <div className='flex items-center justify-between pr-5'>
                    ...
                    <div className='p-3 flex flex-col gap-3'>
                        <div className='flex items-center  border-gray-300 border-b-3'>
                            ...
                            <div className='flex flex-col w-[80%]'>
                                {/* <h5 className='text-xl font-bold'>{ride?.destination}</h5> */}
                                <p className='text-lg  text-gray-800 font-semibold'>{ride?.destination}</p>
                            </div>
                        </div>
                    ...
                    <div className='w-full flex justify-center mt-3'>
                        <button className='bg-green-500 rounded-xl text-white text-xl font-bold p-2 w-full '>Make a payment</button>
                    </div>
           </div>
        </div>
    </div>
